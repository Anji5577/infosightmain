...
import { BeamsBackgroundCanvas } from './components/ui/beams-background';
...
export default function App() {
  return (
    <div className="bg-black text-neutral-300 min-h-screen relative overflow-x-hidden">
      {/* Global Beams Background Canvas */}
      <BeamsBackgroundCanvas className="fixed inset-0 pointer-events-none z-0" />
