...
const InteractiveNeuralVortex: React.FC = () => {
  return (
    <div className="vortex-container relative min-h-screen flex flex-col items-center justify-center overflow-x-hidden font-sans">
      {/* Canvas Background */}
      ...
      {/* Scoped Styles for Showcase elements to prevent global pollution */}
      <style>{`
        @keyframes vortexSlideInUp { 
          from { opacity: 0; transform: translateY(40px); } 
          to { opacity: 1; transform: translateY(0); } 
        }
        .vortex-container .animate-seq {
          animation: vortexSlideInUp 0.8s both;
        }
        .vortex-container .geist-heading {
        ...
        .vortex-container .geist-h1 {
          font-size: 48px;
          line-height: 1.05;
        }
        @media (min-width: 768px) {
          .vortex-container .geist-h1 { font-size: 64px; }
        }
        .vortex-container .geist-h2 {
          font-size: 20px;
          line-height: 1.2;
        }
        .vortex-container .outline-style,
        .vortex-container .outline-btn,
        .vortex-container .outline-card {
